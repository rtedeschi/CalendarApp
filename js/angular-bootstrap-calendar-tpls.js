        ...
        return {
            ...
            controller: [
                ...
                function ($scope, $sce, $timeout, moment, calendarHelper, eventCountBadgeTotalFilter) {
                    ...
                    $scope.dayClicked = function (rowIndex, cellIndex, dayClickedFirstRun, addClicked) {
                        // RT
                        if (addClicked) {
